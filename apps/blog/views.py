...
def explorar(request):
    ...
    categorias_filter = None # para filtrar por categoria, valor por defecto
    items = list(request.GET.items()) # todos los items del request
    page = 1 # pagina por defecto
    
    # si hay parametros se realiza el filtro, sino se muestran todos los posts como en el home
    if items:
